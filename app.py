...
app.config['MAIL_USERNAME'] = 'intrinsicvardhan@gmail.com'  # replace with your Gmail email
app.config['MAIL_PASSWORD'] = ''  # replace with your Gmail password
app.config['MAIL_DEFAULT_SENDER'] = 'avardhan.das@gmail.com' 
...
def perform_mashup():
    try:
        ...
        script_path = os.path.join(os.path.dirname(__file__), 'mashup.py')
